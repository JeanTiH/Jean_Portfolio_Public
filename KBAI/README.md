...
**Overview:**
This directory contains 2 projects completed as part of the KBAI coursework. Each project focuses on implementing real-world applications using **Android development** principles, including intuitive UI design, data persistence, encryption algorithms, and robust functionality.
