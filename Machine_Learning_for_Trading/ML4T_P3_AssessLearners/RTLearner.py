...
# Regression Decision Tree Leaner - RTLearner
...
class RTLearner(object):
    ...
    def decisionTree(self, data_x, data_y):
        ...
        # 2. Randomly pick a feature then split on the median value
        split_index = random.randrange(data_x.shape[1])
